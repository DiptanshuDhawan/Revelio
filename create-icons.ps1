...
$src = New-Object System.Drawing.Bitmap("d:\PhishingDetection\phishguard-ai\icons\icon128.png")
...
$g48.Dispose()
$img48.Save("d:\PhishingDetection\phishguard-ai\icons\icon48.png", [System.Drawing.Imaging.ImageFormat]::Png)
$img48.Dispose()
...
$g16.Dispose()
$img16.Save("d:\PhishingDetection\phishguard-ai\icons\icon16.png", [System.Drawing.Imaging.ImageFormat]::Png)
$img16.Dispose()
